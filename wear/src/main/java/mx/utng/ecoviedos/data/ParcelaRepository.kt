...
object ParcelaRepository {
    ...
    init {
        _parcelas.value = listOf(
            Parcela("4", "Merlot (Default)", "Variedad 1", 1000, 38f, 1.0f, 22f, Date(), true),
            Parcela("5", "Cabernet (Default)", "Variedad 2", 1500, 22f, 1.2f, 24f, Date(), true),
            Parcela("6", "Syrah (Default)", "Variedad 3", 1200, 65f, 0.9f, 21f, Date(), true)
        )
    }
}
